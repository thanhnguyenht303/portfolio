...
export default function RNNModalRes () {
            ...
            <div className="rnn-modal-res">
                ...
                <div className="content">
                    <div className="result">
                        <Image src="/climate-change-project-image/resultImage/rnn-tensor-res.png" 
                            width={700} height={500} alt="rnn tensor" />
                        <div className="matrix-metric">
                        <div className="matrix">
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "black" }}>88</span>
                            ...
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "gray" }}>17</span>
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "gray" }}>0</span>
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "gray" }}>0</span>
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "black" }}>67</span>
                            ...
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "black" }}>143</span>
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "gray" }}>0</span>
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "gray" }}>1</span>
                            ...
                            <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontSize: "1.2rem", fontWeight: 500, backgroundColor: "gray" }}>7</span>
